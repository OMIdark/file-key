...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/papar.link.copy.coro.kn ')
try:
...
def OMIALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/OMIdark/file-key/blob/main/Approval.txt').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  try:
    httpCaht = requests.get(f"https://github.com/OMIdark/file-key/blob/main/Approval.txt").text
    if id in httpCaht:
